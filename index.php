    ...
    <form id="form1" runat="server">
        <div id="precontenedor" class="precontenedor">
            ...
            <!--<div class="recomendados">
                <div class="recomendados_titulo">Juegos Recomendados</div>
                <div class="recomendados_contenedor">
                    <div class="recomendados_imagen">
                        <img src="Styles/Images/imagenpuzzle.png" alt="imagen" />
                    </div>
                    <div class="recomendados_descripcion">
                        Organiza los numeros y gana puntos
                    </div>
                    <div class="recomendados_imagen"></div>
                    <div class="recomendados_descripcion"></div>
                    <div class="recomendados_imagen"></div>
                    <div class="recomendados_descripcion"></div>
                </div>
            </div>-->
